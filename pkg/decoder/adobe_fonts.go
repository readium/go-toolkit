...
func DecodeAdobeFont(publication *pub.Manifest, link pub.Link, reader io.ReadSeeker) (io.ReadSeeker, error) {
	var count int
...
func getAdobeHashKey(publication *pub.Manifest) []byte {
	var stringKey []rune
	var key []byte
